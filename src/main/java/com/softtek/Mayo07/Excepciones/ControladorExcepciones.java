...
public class ControladorExcepciones extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ExcepcionPersonalizadaNoEncontrada.class)
    public ResponseEntity<ExcepcionRespuesta> catchDeNoEncontrado(ExcepcionPersonalizadaNoEncontrada ex, WebRequest peticion){
